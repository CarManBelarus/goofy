...
1. Если по какой-то причине у вас нет Spotify Premium, можете попросить клиент у других пользователей в [телеграм чате](https://t.me/forum_goofy/4998). Поскольку Premium нужен только владельцу клиента. Владелец добавит вас по email в разделе тестировщиков и API для вас заработает без Premium.
